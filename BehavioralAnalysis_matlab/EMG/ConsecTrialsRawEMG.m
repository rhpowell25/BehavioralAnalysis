function ConsecTrialsRawEMG(xds, trial_num, muscle_groups, Save_Figs)
...
if ~strcmp(trial_num, 'All')
    title(sprintf('First %i Succesful Trials: Raw EMG', trial_num),  'FontSize', title_font_size)
else
    title('All Succesful Trials: Raw EMG',  'FontSize', title_font_size)
end
...
if ~strcmp(trial_num, 'All')
    title(sprintf('Last %i Succesful Trials: Raw EMG', trial_num),  'FontSize', title_font_size)
else
    title('All Trials: Raw EMG',  'FontSize', title_font_size)
end
...
if ~isequal(Save_Figs, 0)
    ...
    for ii = 1:numel(findobj('type','figure'))
        save_title = strcat(num2str(trial_num), {' '}, 'Consecutive Succesful Trials, Raw EMG', {' '}, muscle_groups);
